...
switch ($_GET['op']) {
	...
	case 'guardaryeditar':
      ...
      if( isset($_SESSION['permisos']['boletin-parcial']) && 
        in_array('editar' , $_SESSION['permisos']['boletin-parcial']) ){
    ...
    if (!empty($idplanificacion) && !empty($idestudiantes) && !empty($lapso)){
      ...
      if ($rspta->num_rows != 0) {
        ...
        while ($reg = $rspta->fetch_object()) {
          ...
          ( ( isset($_SESSION['permisos']['boletin-parcial']) && 
              in_array('ver' , $_SESSION['permisos']['boletin-parcial']) ) ?
