...
switch ($_GET['op']) {
  ...
  case 'inscribir':
    ...
    $idinscripcion = $Inscripcion->inscribir($idperiodo_escolar, $idplanificacion, $idestudiante, $idrepresentante, $parentesco_representante, $plantel_procedencia_estudiante, $repite, $observaciones, 'CURSANDO') or $sw = FALSE;
