    ...
    if (!empty($idplanificacion) ){
      ...
      if ($rspta->num_rows != 0) {
        while ($reg = $rspta->fetch_object()) {
          ...
          $data[] = array(
          '0' => '<a target="_blank" href="../reporte/boletin-final.php?idplanificacion='.$idplanificacion.'&idestudiante='.$reg->idestudiante.'"> <button class="btn btn-primary" title="Boletín Informativo Final"><i class="fa fa-file"></i></button></a>'. 
