	...
	case 'listar':
		...
		if ($rspta->num_rows != 0) {
			...
			while ($reg = $rspta->fetch_object()) {
				...
				$data[] = array('0' => ($reg->estatus) ? '<button class="btn btn-outline-primary " title="Editar" onclick="mostrar('.$reg->id.')" data-toggle="modal" data-target="#literalModal"><i class="fas fa-edit"></i></button>'.
