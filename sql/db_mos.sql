...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 11-11-2019 a las 02:04:20
...
--
-- Estructura de tabla para la tabla `aspecto_socieconomico`
--

CREATE TABLE `aspecto_socieconomico` (
  `id` int(11) NOT NULL,
  `idestudiante` int(11) NOT NULL,
  `tipo_vivienda` varchar(10) NOT NULL,
  `grupo_familiar` tinyint(2) NOT NULL,
  `ingreso_mensual` decimal(11,2) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `canaima` (
  `id` int(11) NOT NULL,
  `idestudiante` int(11) NOT NULL,
  `posee_canaima` tinyint(1) NOT NULL,
...
--
-- Indices de la tabla `aspecto_socieconomico`
--
ALTER TABLE `aspecto_socieconomico`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idestudiante` (`idestudiante`);
...
--
-- AUTO_INCREMENT de la tabla `aspecto_socieconomico`
--
ALTER TABLE `aspecto_socieconomico`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- Filtros para la tabla `aspecto_socieconomico`
--
ALTER TABLE `aspecto_socieconomico`
