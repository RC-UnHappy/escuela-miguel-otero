...
if (isset($_SESSION['permisos']['personal']) && in_array('ver' , $_SESSION['permisos']['personal'])) {
?>
<!-- Contenido -->
<main class="main">
      ...
      <div class="card border-light mb-3 shadow p-3 mb-5 bg-white rounded ">
        ...
        <div class="card-header pt-0 pb-1 bg-white mb-3"> <!-- Botonera del panel -->
          ...
          <h1 class="font-weight-normal h5">Personal
            ...
            <?php              
              if( isset($_SESSION['permisos']['personal']) && 
                  in_array('agregar' , $_SESSION['permisos']['personal']) ){
                echo 
