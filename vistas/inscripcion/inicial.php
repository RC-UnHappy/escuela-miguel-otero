                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="row" id="comienzoFormulario">
                                                        ...
                                                        <div class="form-group col-md-3">
                                                            ...
                                                            <div class="input-group">
                                                                <select id="pais_nacimiento_estudiante" name="pais_nacimiento_estudiante" class="form-control selectpicker" required>
                                                                    <option value="">Seleccione</option>
                                                        ...
                                                        <div class="form-group col-md-3">
                                                            ...
                                                            <div class="input-group">
                                                                <select id="estado_nacimiento_estudiante" name="estado_nacimiento_estudiante" class="form-control selectpicker" required disabled>
                                                                    <option value="">Seleccione</option>
                                                        ...
                                                        <div class="form-group col-md-3">
                                                            ...
                                                            <div class="input-group">
                                                                <select id="municipio_nacimiento_estudiante" name="municipio_nacimiento_estudiante" class="form-control selectpicker" required disabled>
                                                                    <option value="">Seleccione</option>
                                                        ...
                                                        <div class="form-group col-md-3">
                                                            ...
                                                            <div class="input-group">
                                                                <select id="parroquia_nacimiento_estudiante" name="parroquia_nacimiento_estudiante" class="form-control selectpicker" required disabled>
                                                                    <option value="">Seleccione</option>
