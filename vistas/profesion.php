...
if (!isset($_SESSION['idusuario'])) {
    ...
    if (isset($_SESSION['permisos']['profesion']) && in_array('ver', $_SESSION['permisos']['profesion'])) {
?>
                ...
                <div class="container panel-principal col-sm-12">
                    <div class="card border-light mb-3 shadow p-3 mb-5 bg-white rounded ">
                        ...
                        <div class="card-header pt-0 pb-1 bg-white mb-3">
                            ...
                            <!-- Botón para mostrar modal profesion -->
                            <h1 class="font-weight-normal h5">Profesión
                                <?php
                                if (
                                    isset($_SESSION['permisos']['profesion']) &&
                                    in_array('agregar', $_SESSION['permisos']['profesion'])
                                ) {
                                    echo
                                    '<button class="btn btn-outline-primary btn-pill shadow-sm" data-toggle="modal" data-target="#profesionModal" id="btnAgregar">
                        ...
                        <div class="modal fade" id="profesionModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog rounded" role="document">
                                <div class="modal-content">
                                    ...
                                    <form class="needs-validation" novalidate name="formularioProfesion" id="formularioregistros">
                                        <!-- Formulario de profesion -->

                                        <div class="modal-header fondo-degradado rounded">
                                            <h5 class="modal-title text-white" id="exampleModalLabel">Crear Profesión</h5>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control profesion text-uppercase" name="profesion" id="profesion" required>

                                                        <input type="hidden" name="idprofesion" id="idprofesion"> <!-- Input oculto que guardará el id de la profesion cuando sea necesario -->
    ...
    ?>
    <script src="scripts/profesion.js"></script>
