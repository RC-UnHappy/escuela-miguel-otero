...
if (isset($_SESSION['permisos']['lapso-academico']) && in_array('ver' , $_SESSION['permisos']['lapso-academico'])) {
?>
      ...
      <div class="card border-light mb-3 shadow p-3 mb-5 bg-white rounded ">
        ...
        <div class="card-header pt-0 pb-1 bg-white mb-3"> <!-- Botonera del panel -->
          ...
          <h1 class="font-weight-normal h5">Lapso académico
            ...
            <?php              
              if( isset($_SESSION['permisos']['lapso-academico']) && 
                  in_array('agregar' , $_SESSION['permisos']['lapso-academico']) ){
                echo 
        ...
        <!-- Modal para mostrar los estudiantes que no tengan la nota completa -->
        <div class="modal fade" id="noCompletaModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
          <div class="modal-dialog rounded " role="document">
            <div class="modal-content">
                ...
                <div class="modal-body" id="estudiantesSinNotas">
