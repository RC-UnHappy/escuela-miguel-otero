...
if (isset($_SESSION['permisos']['planificacion']) && in_array('ver' , $_SESSION['permisos']['planificacion'])) {
?>
          ...
          <div class="row">
            ...
            <div class="pl-3 col-md-6 d-flex justify-content-start">
              ...
              <h1 class="font-weight-normal h5">Planificación
                ...
                <?php              
                  if( isset($_SESSION['permisos']['planificacion']) && 
                      in_array('agregar' , $_SESSION['permisos']['planificacion']) ){
                    echo 
