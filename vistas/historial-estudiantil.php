      ...
      <div class="card border-light mb-3 shadow p-3 mb-5 bg-white rounded ">
        ...
        <div class="card-header pt-0 pb-1 bg-white mb-3">
          ...
          <div class="row">
            ...
            <div class="d-flex justify-content-end col-md-6 offset-2">
              <p class="h5 font-weight-normal mt-1 mr-6">Período escolar</p>
              <select name="periodo_escolar_general" id="periodo_escolar_general" class="form-control selectpicker col-6">
              ...
              <table class="table table-borderless table-striped" id="tblistado">
                ...
                <thead class="fondo-degradado text-white">
                  <tr>
                    ...
                    <th scope="col">Primer nombre estudiante</th>
                    <th scope="col">Segundo nombre estudiante</th>
                    <th scope="col">Primer apellido estudiante</th>
                    <th scope="col">Segundo apellido estudiante</th>
                  ...
                  <div class="row">
                    ...
                    <div class="form-group col-lg-6 col-xl-3">
                      ...
                      <div class="input-group ">
                        ...
                        <input type="text" class="form-control solo_numeros" placeholder="Ej: 12345678" name="cedula_docente" id="cedula_docente" maxlength="8" minlength="6">
                    ...
                    <div class="form-group col-lg-6 col-xl-3">
                      ...
                      <div class="input-group ">
                        ...
                        <input type="text" class="form-control solo_numeros" placeholder="Ej: 12345678" name="cedula_estudiante" id="cedula_estudiante" maxlength="11" minlength="7">
