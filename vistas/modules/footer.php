            ...
            <div class="list-group list-group-accent">
              ...
              <div class="list-group-item list-group-item-accent-primary list-group-item-divider">
                ...
                <div class="avatars-stack mt-2">
                  ...
                  <div class="avatar avatar-xs">
                    <img class="img-avatar" src="../public/img/avatars/8.jpg" alt="admin@bootstrapmaster.com">
                  </div>
                </div>
              </div>
            </div>
    ...
    <script src="../public/js/coreui.min.js"></script>

    <!-- Plugins and scripts required by this view-->
    <script src="../public/js/Chart.min.js"></script>
    <script src="../public/js/custom-tooltips.min.js"></script>
    <!-- <script src="../public/js/main.js"></script> -->
    <!-- <script src="../public/js/widgets.js"></script> -->

    <!-- Fuentes de la aplicación -->
    <script src="../public/js/solid.min.js"></script>
    <script src="../public/js/regular.min.js"></script>
