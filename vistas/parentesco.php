...
if (!isset($_SESSION['idusuario'])) {
    ...
    if (isset($_SESSION['permisos']['parentesco']) && in_array('ver', $_SESSION['permisos']['parentesco'])) {
?>
                ...
                <div class="container panel-principal col-sm-12">
                    <div class="card border-light mb-3 shadow p-3 mb-5 bg-white rounded ">
                        ...
                        <div class="card-header pt-0 pb-1 bg-white mb-3">
                            ...
                            <!-- Botón para mostrar modal parentesco -->
                            <h1 class="font-weight-normal h5">Parentesco
                                <?php
                                if (
                                    isset($_SESSION['permisos']['parentesco']) &&
                                    in_array('agregar', $_SESSION['permisos']['parentesco'])
                                ) {
                                    echo
                                    '<button class="btn btn-outline-primary btn-pill shadow-sm" data-toggle="modal" data-target="#parentescoModal" id="btnAgregar">
                  <i class="fa fa-plus-circle"></i> Agregar
                            ...
                            <div class="col-sm-12">
                                <div class="table-responsive">
                                    <table class="table table-borderless table-striped" id="tblistado">
                                        <caption>Lista de parentescos</caption>
                        ...
                        <!-- Modal para crear parentesco -->
                        <div class="modal fade" id="parentescoModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog rounded" role="document">
                                <div class="modal-content">

                                    <form class="needs-validation" novalidate name="formularioParentesco" id="formularioregistros">
                                        <!-- Formulario de parentesco -->

                                        <div class="modal-header fondo-degradado rounded">
                                            <h5 class="modal-title text-white" id="exampleModalLabel">Crear Parentesco</h5>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control parentesco text-uppercase" name="parentesco" id="parentesco" required>

                                                        <input type="hidden" name="idparentesco" id="idparentesco"> <!-- Input oculto que guardará el id de la parentesco cuando sea necesario -->
    ...
    ?>
    <script src="scripts/parentesco.js"></script>
