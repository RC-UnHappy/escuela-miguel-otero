...
if (!isset($_SESSION['idusuario'])) {
    ...
    if (isset($_SESSION['permisos']['enfermedad']) && in_array('ver', $_SESSION['permisos']['enfermedad'])) {
?>
                ...
                <div class="container panel-principal col-sm-12">
                    <div class="card border-light mb-3 shadow p-3 mb-5 bg-white rounded ">
                        ...
                        <div class="card-header pt-0 pb-1 bg-white mb-3">
                            ...
                            <!-- Botón para mostrar modal enfermedad -->
                            <h1 class="font-weight-normal h5">Enfermedad
                                <?php
                                if (
                                    isset($_SESSION['permisos']['enfermedad']) &&
                                    in_array('agregar', $_SESSION['permisos']['enfermedad'])
                                ) {
                                    echo
                                    '<button class="btn btn-outline-primary btn-pill shadow-sm" data-toggle="modal" data-target="#enfermedadModal" id="btnAgregar">
                  <i class="fa fa-plus-circle"></i> Agregar
                            ...
                            <div class="col-sm-12">
                                <div class="table-responsive">
                                    <table class="table table-borderless table-striped" id="tblistado">
                                        <caption>Lista de enfermedades</caption>
                        ...
                        <!-- Modal para crear enfermedad -->
                        <div class="modal fade" id="enfermedadModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog rounded" role="document">
                                <div class="modal-content">

                                    <form class="needs-validation" novalidate name="formularioEnfermedad" id="formularioregistros">
                                        <!-- Formulario de enfermedad -->

                                        <div class="modal-header fondo-degradado rounded">
                                            <h5 class="modal-title text-white" id="exampleModalLabel">Crear Enfermedad</h5>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control enfermedad text-uppercase" name="enfermedad" id="enfermedad" required>

                                                        <input type="hidden" name="idenfermedad" id="idenfermedad"> <!-- Input oculto que guardará el id de la enfermedad cuando sea necesario -->
    ...
    ?>
    <script src="scripts/enfermedad.js"></script>
