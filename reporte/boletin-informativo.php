...
$pdf->Cell(45,5,utf8_decode(ucfirst($datos_reporte['p_nombre']).' '.ucfirst($datos_reporte['p_apellido'])),'B',0,'L');
$pdf->Cell(60,5,utf8_decode('Título del Proyecto de Aprendizaje: '),0,0,'L');
$pdf->Cell(60,5,utf8_decode(ucfirst($datos_reporte['proyecto_aprendizaje'])),'B',1,'L');
...
foreach ($indicadores_nota as $materia => $indicadores_nota) {
  ...
  $pdf->MultiCell($ancho_area,($numero_indicadores * 6) / 2,utf8_decode($materia),1,'C');
