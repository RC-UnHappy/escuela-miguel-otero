...
$pdf->cell(50,5,utf8_decode("Docente: Carlos Diamon".$docente),0,0,'C');
$pdf->cell(30,5,'Grado: 6'.$grado,0,0,'C');
$pdf->cell(40,5,utf8_decode('Sección: A'.$seccion),0,0,'C');
$pdf->cell(30,5,utf8_decode('Año escolar: 2020-2021'.$año),0,0,'C');
$pdf->Ln(12);
