...
class AspectoFisiologico
{
  ...
  function insertar($idplanificacion, $idestudiante, $peso, $talla, $todas_vacunas, $alergia, $c, $alimentos, $utiles, $alergias, $vacunas, $alimentostxt, $utilestxt)
  {
    $sql = "INSERT INTO aspecto_fisiologicos (id, idplanificacion, idestudiante ,peso, talla, todas_vacunas,alergia, c, alimentos, utiles, alergias, vacunas, alimentostxt, utilestxt) VALUES(NULL, '$idplanificacion', '$idestudiante', '$peso', '$talla', '$todas_vacunas', '$alergia', '$c', '$alimentos', '$utiles', '$alergias', '$vacunas', '$alimentostxt','$utilestxt')";
  ...
  function editar($idaspectofisiologico, $peso, $talla, $todas_vacunas, $alergia, $c, $alimentos, $utiles, $vacunas, $alergias, $alimentostxt, $utilestxt)
  {
    $sql = "UPDATE aspecto_fisiologicos SET peso = '$peso', talla = '$talla', todas_vacunas = '$todas_vacunas', alergia = '$alergia', c = '$c', alimentos = '$alimentos', utiles = '$utiles', vacunas = '$vacunas', alergias = '$alergias', alimentostxt = '$alimentostxt', utilestxt = '$utilestxt' WHERE id = '$idaspectofisiologico'";
