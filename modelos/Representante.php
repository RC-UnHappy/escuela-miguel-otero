...
class Representante
{
	...
	// Método para obetner los datos del representante por medio del idpersona
	function representanteporidpersona($idpersona) 
	{
		$sql = "SELECT * FROM representante WHERE idpersona = '$idpersona'";
